...
- The README in the package is the README of the tagged commit, which 0.3.0's was not.
...
[0.3.1]: https://github.com/adilson-arcoverde/sf-shield-events/compare/v0.3.0...v0.3.1
